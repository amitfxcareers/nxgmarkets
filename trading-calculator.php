      ...
      <div class="row">
         <div class="col-md-6">
            <div class="banner_content ">
               ...
               <p class="text-white">
                  Refine Your Strategy with Our Trade Calculator – The Essential Tool for Accurate Trade Planning.
               </p>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12 text-center">
            ...
            <p>
               Refine your trading strategy with NXG Markets’ essential Trading Calculators. These powerful tools, including pip and margin calculators, enable precise calculations for potential profits, losses, and margin requirements. Elevate your risk management and trade confidently using our suite of Trading Calculators.
            </p>
...
<section class="funding-withdrawal">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
                  ...
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                     <div class="container">
                        ...
                        <div class="row mt-4">
                           <div class="col-md-12">
                              <p>
                                 <b>Skrill ID</b> : skrill@nxgmarkets.com
                              </p>
                              <p>
                                 <b>Note</b> : Instant withdrawal limit upto $1500. Above it will take 24-48 hrs.
                              </p>
                              <p>
                                 <b>Note</b> : Conversion charges would be 2% only on deposits
                              </p>
                           </div>
                        </div>
                     </div>
      ...
      <div class="row align-items-center">
         <div class="col-md-6">
            ...
            <div class="icon-box">
               ...
               <p class="description">Choose from MT4, MT5, cTrader. Trade seamlessly on the platform that suits your style and preferences.</p>
            </div>
            <div class="icon-box">
               <div class="icon">
