...
<section class="why-join-ib">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h2 class="refer-heading fw-800">
                    Grow Your Network, Grow Your Rewards
                </h2>
                <p>
                    Building a strong network is valuable, and with NXG Markets’ Refer & Shop contest, it’s even more rewarding. Introduce your friends to the world of trading and get rewarded with up to $1,000 in Amazon vouchers when they meet simple deposit and trading goals.
                </p>
            </div>
            <div class="col-md-12">
                <h2 class="fw-800">
                ...
                <p>
                    You refer your friends, and when they open an account with NXG Markets, and make a deposit, everyone wins. Your friends gain access to a powerful trading platform packed with features, allowing them to trade various financial instruments. While they explore exciting trading opportunities, you get rewarded with Amazon vouchers you can spend on anything you desire. It’s a fantastic way to expand your network, support your friends’ financial goals, and earn valuable rewards at the same time. Don’t forget to meet the minimum eligibility criteria and aim for the top.
                </p>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-6 text-center">
                <div class="sidebar-sticky">
                    <img src="images/stage.png" class="img-fluid">
                </div>
            </div>
            <div class="col-md-6">
                <h2 class="fw-800">
                ...
                <div class="ib-table mt-4">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <img src="images/deposit.png" class="img-fluid" width="10%">Gross Deposit
                                </td>
                                <td>
                                    $10,000
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="images/graph-bar.png" class="img-fluid" width="10%">Volume
                                </td>
                                <td>
                                    100 Lots
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="images/voucher.png" class="img-fluid" width="10%">Amazon Voucher
                                </td>
                                <td>
                                    $150
                                </td>
