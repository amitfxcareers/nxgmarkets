...
<section class="refund-policy">
   <div class="container">
      <div class="col-md-12">
         ...
         <p>
            In order to start the return process the Client shall submit a cancellation request by emailing to finance@nxgmarkets.com. A cancellation request shall contain the following information at least but not limited to:
         </p>
         <ol>
            <li>
