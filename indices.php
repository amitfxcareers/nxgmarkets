		...
		<div class="row">
			<div class="col-md-6">
				<div class="banner_content ">
					...
					<p class="text-white">
						At NXG Markets, trade a variety of indices effortlessly. Enjoy competitive trading conditions and explore the potential of index trading with us.
					</p>
      ...
      <div class="row align-items-center">
         <div class="col-md-6">
            ...
            <div class="icon-box">
               ...
               <p class="description">Take advantage of tight spreads, low commissions, and fast order execution. We strive to provide you with the best trading conditions for index trading.</p>
            </div>
            <div class="icon-box">
               <div class="icon">
...
<section class="trade-section">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2 class="main-heading">Trade Indices</h2>
				<p class="text-center">
