...
<!-- Banner -->
<div id="carouselExampleCaptions" class="carousel slide home-banner">
    ...
    <div class="carousel-item active">
      <div class="container">
        <div class="row align-items-center banner-sec">
          <div class="col-md-6">
            <div class="banner-content-pointers">
              <h2>
                Refer & Shop Affiliate Contest
              </h2>
              <ul class="banner-ul">
                <li>
                  <img src="images/meet-deposite-and-volume-targets.png" class="img-fluid">
                  Refer Clients to NXG Markets
                </li>
                <li>
                  <img src="images/meet-deposite-and-volume-targets.png" class="img-fluid">
                  Meet Deposit & Volume Targets
                </li>
                <li>
                  <img src="images/meet-deposite-and-volume-targets.png" class="img-fluid">
                  Win Amazon Shopping Vouchers upto $1000
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="carousel-item">
      <div class="container">
        <div class="row align-items-center banner-sec">
          ...
          <div class="col-md-6">
            <img src="images/slide2.png" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row align-items-center banner-sec">
          <div class="col-md-6">
            <div class="banner-content-pointers">
              <h2>
                Trade Better, Trade Smarter Trade with NXG Markets
              </h2>
              <ul class="banner-ul">
                <li>
                  <img src="images/meet-deposite-and-volume-targets.png" class="img-fluid">
    ...
    <div class="row g-4 align-items-center">
      <div class="col-lg-6">
        <div class="vertical_tabs_trade">
          ...
          <div class="d-flex align-items-start tabs-v">
            ...
            <div class="tab-content" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="v-pills-forex" role="tabpanel" aria-labelledby="v-pills-forex-tab">
                <p>EUR/USD</p>
                <p>USD/IPY</p>
                <p>GBP/USD</p>
                <p>AUD/USD</p>
    ...
    <div class="row g-4 align-items-center">
      ...
      <div class="col-md-6">
        <div class="autochartist_content_right">
          ...
          <div class=" mt-lg-5 mt-4 d-inline-block">
            <a href="https://my.nxgmarkets.com/auth/register" class="theme-bttn"><i class="fa fa-phone" aria-hidden="true"></i>Get In Touch</a>
          </div>
        </div>
      </div>
        ...
        <div class="road-map-main">
          <div class="road-map-wrapper">
            <div class="road-map-circle">
              <span class="road-map-circle-text d-flex align-items-center justify-content-center">1</span>
            </div>
          ...
          <div class="road-map-wrapper">
            <div class="road-map-circle">
              <span class="road-map-circle-text d-flex align-items-center justify-content-center">2</span>
            </div>
            <div class="road-map-card">
          ...
          <div class="road-map-wrapper">
            <div class="road-map-circle">
              <span class="road-map-circle-text d-flex align-items-center justify-content-center">3</span>
            </div>
            <div class="road-map-card">
